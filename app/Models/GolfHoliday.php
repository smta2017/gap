...
class GolfHoliday extends Model
{
    ...
    {
        return $this->belongsToMany(Tag::class, 'golf_holiday_tag');
    }
    ...
    {
        return $this->belongsToMany(Product::class, 'golf_holiday_product');
    }

    public function hotels()
    {
        return $this->belongsToMany(Hotel::class, 'golf_holiday_hotel');
    }
