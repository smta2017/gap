...
class CreateDMCSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dmcs', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('has_hotels')->default(0)->nullable();
            $table->boolean('has_golf_courses')->default(0)->nullable();
